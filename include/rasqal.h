 ...
 */
#define RASQAL_VERSION_STRING "0.9.26"
 ...
 */
#define RASQAL_VERSION_RELEASE 26
 ...
 */
#define RASQAL_RAPTOR_VERSION 20003
 ...
 * @timezone_minutes: minutes +/- against UTC or RASQAL_XSD_DATETIME_NO_TZ if there isno timezone in the dateTime.
 *
...
typedef enum {
  ...
  RASQAL_EXPR_SHA512,
  /* internal */
  RASQAL_EXPR_LAST = RASQAL_EXPR_SHA512
} rasqal_op;
...
RASQAL_API
rasqal_data_graph* rasqal_new_data_graph_from_iostream(rasqal_world* world, raptor_iostream* iostr, raptor_uri* base_uri, raptor_uri* name_uri, int flags, const char* format_type, const char* format_name, raptor_uri* format_uri);
RASQAL_API
...
RASQAL_API
rasqal_service* rasqal_new_service(rasqal_world* world, raptor_uri* service_uri, const char* query_string, raptor_sequence* data_graphs);
RASQAL_API
